...
import blueStick from "../../assets/icons/blueStick.png";
...
export const Tutorial = () => {
  ...
  return (
    <div
      ...
      className="h-full pt-6 px-4 bg-[#F8F8F8] overflow-auto pb-[70px] relative"
    >
        ...
        <div className="space-y-3 flex flex-col justify-between ">
          ...
          <div className="z-30">
            <div
              ...
              style={{
                cursor: "pointer",
                boxShadow: "0 5px 50px 5px rgba(0, 94, 237, 0.6)", // 드롭 섀도우 적용
              }}
              onClick={() => {
                navigate("/account");
              }}
